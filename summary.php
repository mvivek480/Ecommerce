...
if(isset($email)){ } else { header('location:index.php'); } 
?>
<!Doctype html>
<html>
	<head> 
	...
	<body> 
		<div class="container" ng-app="myApp2">
			...
			<div class="header animated fadeInDown">
				<div class="a">
					<span class=""><a href="home.php"><i class="fa fa-home"></i> <p class="rwd">Home</p></a></span>
					<span class="active"><a href="orders.php"><i class="fa fa-folder-open active"></i> <p class="rwd active">Orders</p></a></span>
					<span class=""><a href="user.php"><i class="fa fa-image"></i> <p class="rwd">Gallery</p></a></span>
				...
				<div class="c">
					...
					<a href="cart.php"><span><p class="login" ng-controller="count"><i class="fa fa-shopping-cart"></i> <kbd ng-repeat="x in names" ng-show="{{ x.count }} > 0">{{ x.count }}</kbd></p></span></a>
						...
						<div class="ordertrucking">
							<table>
								...
								<tr> 
									...
									<td><a href="orders.php"><button>View Status</button></a></td>
								</tr>
							</table>
							<br>
							<?php
